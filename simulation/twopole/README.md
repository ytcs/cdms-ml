...
You can force your model to be physical by pre/post-processing but any such processing should be integrated inside the network to ensure differentiability.
