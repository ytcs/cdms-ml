...
The repo contains standardized datasets for tasks that build towards developing a fully functional reconstruction pipeline for SuperCDMS detectors. Think of this as CIFAR or MNIST for CDMS.
